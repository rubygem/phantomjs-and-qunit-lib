...
var _ = require('underscore'),
	routeRepository = new MongoRepository(process.env.DATA_STORE_CONNECTION_STRING,'routes-transit');


var TransitRouteStore = function(){
	...
	var find = function(transitProviderName, callback){
		var query = {_id: transitProviderName};
...
module.exports = TransitRouteStore;